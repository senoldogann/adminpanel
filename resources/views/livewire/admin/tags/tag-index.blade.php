<div>
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-semibold">Etiketler</h2>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="p-4 border-b">
            <input wire:model.debounce.300ms="search" type="search" placeholder="Etiket ara..." class="w-full px-4 py-2 border rounded">
        </div>
                    ...
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="h-4 w-4 rounded mr-2" style="background-color: {{ $tag->color ?? '#ccc' }}"></div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-500">{{ $tag->posts->count() }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="{{ route('admin.tags.edit', $tag) }}" class="text-blue-600 hover:text-blue-900 mr-3">Düzenle</a>
                            <button wire:click="openDeleteModal({{ $tag->id }})" class="text-red-600 hover:text-red-900">Sil</button>
                        </td>
                    </tr>
                @empty
                    <tr>
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">
                                "{{ $name }}" etiketini silmek istediğinizden emin misiniz? Bu işlem geri alınamaz ve etiket kalıcı olarak silinecektir.
                            </p>
                        </div>
                    </div>
                </div>
