<div>
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-semibold">Yeni Yazı</h2>
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea
                        ...
                        rows="3"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Yazı özeti (opsiyonel)"
                    ></textarea>
                ...
                <div>
                    <label for="featured_image" class="block text-sm font-medium text-gray-700 mb-1">Öne Çıkan Görsel</label>
                    <input
                        type="file"
                        id="featured_image"
                    ...
                    @if ($featured_image)
                        <div class="mt-2">
                            <p class="text-sm text-gray-500 mb-1">Önizleme:</p>
                            <img src="{{ $featured_image->temporaryUrl() }}" class="w-40 h-40 object-cover rounded">
                        </div>
                    @endif
                </div>
