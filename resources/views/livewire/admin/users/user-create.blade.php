            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-2xl font-semibold">Yeni Kullanıcı</h2>
                    ...
                    <form wire:submit.prevent="save">
                        ...
                        <!-- Avatar -->
                        <div class="mt-6">
                            <label for="avatar" class="block text-sm font-medium text-gray-700 mb-1">Profil Fotoğrafı</label>
                            <input 
                                type="file" 
                                id="avatar" 
                                wire:model="avatar" 
                            ...
                            @if ($avatar)
                                <div class="mt-2">
                                    <img src="{{ $avatar->temporaryUrl() }}" class="h-20 w-20 object-cover rounded-full">
                                </div>
                            @endif
                        </div>
