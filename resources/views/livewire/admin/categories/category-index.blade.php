<div>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="p-4 border-b">
            <input wire:model.debounce.300ms="search" type="search" placeholder="Kategori ara..." class="w-full px-4 py-2 border rounded">
        </div>
                ...
                @forelse ($categories as $category)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            ...
                            <button wire:click="openDeleteModal({{ $category->id }})" class="text-red-600 hover:text-red-900">Sil</button>
                        </td>
                    </tr>
                @empty
                    <tr>
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">
                                "{{ $name }}" kategorisini silmek istediğinizden emin misiniz? Bu işlem geri alınamaz ve kategori kalıcı olarak silinecektir.
                            </p>
                        </div>
                    </div>
                </div>
